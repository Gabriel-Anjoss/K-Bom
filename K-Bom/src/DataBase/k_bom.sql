...
CREATE TABLE `administrador` (
  ...
  `URL_FotoPefil` varchar(255) NULL,
  `Token` varchar(200) NULL,
  `Token_expira_em` TIMESTAMP NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


INSERT INTO `administrador` (`ID_adm`, `Nome_adm`, `Senha`, `Email`, `CPF`, `Data_Nasc`, `URL_FotoPefil`, `Token`, `Token_expira_em`) VALUES
(1, 'Guilherme Oliveira', 'mi130807', 'guivini138@gmail.com', '54001643820', '2007-08-13','http://tentreosbrothers.shop/Guilherme/KBom/FotoPerfil/Padrao.png', NULL, NULL);

INSERT INTO `administrador` (`ID_adm`, `Nome_adm`, `Senha`, `Email`, `CPF`, `Data_Nasc`, `URL_FotoPefil`, `Token`, `Token_expira_em`) VALUES
(2, 'Edna', '123', 'edna', '08033636050', '2000-10-10', 'http://tentreosbrothers.shop/Guilherme/KBom/FotoPerfil/Padrao.png', NULL, NULL);
...
--
ALTER TABLE `imagens`
  ADD CONSTRAINT `imagens_ibfk_1` FOREIGN KEY (`ID_Prod`) REFERENCES `produto` (`ID_produto`);
