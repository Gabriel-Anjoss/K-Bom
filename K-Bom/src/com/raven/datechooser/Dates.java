...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo.setForeground(new java.awt.Color(0, 96, 177));
        cmdMo.setText("D");
        add(cmdMo);

        cmdTu.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        cmdTu.setForeground(new java.awt.Color(0, 96, 177));
        cmdTu.setText("S");
        add(cmdTu);

        cmdWe.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        cmdWe.setForeground(new java.awt.Color(0, 96, 177));
        cmdWe.setText("T");
