...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        sVGImage9.setSvgImage("Imagens/shield_person.svg", 40, 40); //Sair
        sVGImage9.setCursor(new Cursor(Cursor.HAND_CURSOR));
        sVGImage10.setSvgImage("Imagens/manage_accounts.svg", 40, 40); //Sair
        sVGImage10.setCursor(new Cursor(Cursor.HAND_CURSOR));
        sVGImage11.setSvgImage("Imagens/inventory_2.svg", 40, 40); //Sair
        ...
        setupHoverEffect(sVGImage9, roundedPanel7, startColor, hoverColor);
        setupHoverEffect(sVGImage10, roundedPanel8, startColor, hoverColor);
        setupHoverEffect(sVGImage11, roundedPanel9, startColor, hoverColor);
        ...
        sVGImage9.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                cadastroADM mostra2 = new cadastroADM();
        ...
        sVGImage10.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
    ...
    private void verificaADM() throws SQLException {
        String token;
        login log = new login();
        token = log.lerDados();

        String sql = "SELECT ID_adm FROM administrador WHERE Token = ?";

        // O try-with-resources garante que os recursos sejam fechados automaticamente
        try (Connection conexao = con_cliente.getConnection();
             PreparedStatement pst = conexao.prepareStatement(sql)) {

            pst.setString(1, token);  // Define o valor do token

            try (ResultSet rs = pst.executeQuery()) {  // Executa a consulta
                if (rs.next()) {  // Se houver resultado
                    int idAdm = rs.getInt("ID_adm");  // Obtém o valor do ID_adm

                    // Aqui você pode colocar o que deve ser feito se o ID_adm for encontrado
                    // por exemplo: exibir telas do administrador.

                } else {
                    // Se não encontrar o token de administrador, oculta os componentes.
                    sVGImage9.setVisible(false);
                    roundedPanel7.setVisible(false);
                    sVGImage10.setVisible(false);
                    roundedPanel8.setVisible(false);
                    sVGImage11.setVisible(false);
                    roundedPanel9.setVisible(false);
                }
            }
        }
    }
    ...
    private void initComponents() {
        ...
        sVGImage9 = new javaswingdev.SVGImage();
        roundedPanel7 = new javaswingdev.RoundedPanel();
        sVGImage10 = new javaswingdev.SVGImage();
        roundedPanel8 = new javaswingdev.RoundedPanel();
        sVGImage11 = new javaswingdev.SVGImage();
        roundedPanel9 = new javaswingdev.RoundedPanel();
        jTabbedPane1 = new javax.swing.JTabbedPane();
        jPanel5 = new javax.swing.JPanel();
        home1 = new Telas.Home();
        ...
        manageAccount1 = new Telas.ManageAccount();
        ...
        sVGImage9.setMaximumSize(new java.awt.Dimension(40, 40));
        sVGImage9.setMinimumSize(new java.awt.Dimension(40, 40));
        sVGImage9.setPreferredSize(new java.awt.Dimension(40, 40));
        secondMenu1.add(sVGImage9);
        sVGImage9.setBounds(20, 479, 40, 40);

        roundedPanel7.setBackground(new java.awt.Color(0, 96, 177));
        roundedPanel7.setMaximumSize(new java.awt.Dimension(50, 50));
        roundedPanel7.setMinimumSize(new java.awt.Dimension(50, 50));
        ...
        secondMenu1.add(roundedPanel7);
        roundedPanel7.setBounds(15, 474, 50, 50);

        sVGImage10.setMaximumSize(new java.awt.Dimension(40, 40));
        sVGImage10.setMinimumSize(new java.awt.Dimension(40, 40));
        sVGImage10.setPreferredSize(new java.awt.Dimension(40, 40));
        secondMenu1.add(sVGImage10);
        sVGImage10.setBounds(20, 539, 40, 40);

        roundedPanel8.setBackground(new java.awt.Color(0, 96, 177));
        roundedPanel8.setMaximumSize(new java.awt.Dimension(50, 50));
        roundedPanel8.setMinimumSize(new java.awt.Dimension(50, 50));
        ...
        secondMenu1.add(roundedPanel8);
        roundedPanel8.setBounds(15, 534, 50, 50);

        sVGImage11.setMaximumSize(new java.awt.Dimension(40, 40));
        sVGImage11.setMinimumSize(new java.awt.Dimension(40, 40));
        sVGImage11.setPreferredSize(new java.awt.Dimension(40, 40));
        secondMenu1.add(sVGImage11);
        sVGImage11.setBounds(20, 599, 40, 40);

        roundedPanel9.setBackground(new java.awt.Color(0, 96, 177));
        roundedPanel9.setMaximumSize(new java.awt.Dimension(50, 50));
        roundedPanel9.setMinimumSize(new java.awt.Dimension(50, 50));
        ...
        secondMenu1.add(roundedPanel9);
        roundedPanel9.setBounds(15, 594, 50, 50);
        ...
        jPanel14.add(manageAccount1);
        manageAccount1.setBounds(0, 0, 1303, 655);
    ...
    private Telas.ManageAccount manageAccount1;
    ...
    private javaswingdev.RoundedPanel roundedPanel7;
    private javaswingdev.RoundedPanel roundedPanel8;
    private javaswingdev.RoundedPanel roundedPanel9;
    public javaswingdev.SVGImage sVGImage1;
    public javaswingdev.SVGImage sVGImage10;
    public javaswingdev.SVGImage sVGImage11;
    ...
    public javaswingdev.SVGImage sVGImage9;
