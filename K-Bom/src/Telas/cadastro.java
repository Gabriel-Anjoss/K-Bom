...
public class cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(250, 100, 170, 41);
        ...
        jLabel12.setBounds(450, 480, 50, 20);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(330, 100, 280, 25);
                ...
                if(isCPFValido(CPF)) {
                    if(validarData(date, 14)) {
                        if(con_cliente.conecta()) {
                            String cadastro = "INSERT INTO cliente (Nome_Cli, Senha, Email, CPF, Data_Nasc, URL_FotoPefil, Token) VALUES (?, ?, ?, ?, ?, ?, ?)";
